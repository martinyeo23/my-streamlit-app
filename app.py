...
st.title("Singapore HDB Resale Dashboard v1.1")
...
unique_street_name = sorted(df["street_name"].dropna().unique())
...
selected_street_name = st.sidebar.multiselect("Street Name", unique_street_name, default=[])
...
if selected_street_name:
    filtered_df = filtered_df[filtered_df["street_name"].isin(selected_street_name)]
